...
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.KEY_ANSWER;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.KEY_OPTA;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.KEY_ID;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.KEY_OPTB;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.KEY_OPTC;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.KEY_QUES;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry.TABLE_QUEST;
import static com.dorvis.quizapp.sql.QuizContract.MovieEntry2.TABLE_PYTHON;
...
public class AndyDatabaseHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "trivquiz.db";
    // tasks table name
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        addQuestions();
        String sql2 = "CREATE TABLE IF NOT EXISTS " + TABLE_PYTHON  + " ( "
                + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + KEY_QUES
                + " TEXT, " + KEY_ANSWER+ " TEXT, "+KEY_OPTA +" TEXT, "
                +KEY_OPTB +" TEXT, "+KEY_OPTC+" TEXT)";
